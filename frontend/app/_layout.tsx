  ...
  const ui = (
    <LoadingProvider>
      ...
      <Stack>
        ...
        <Stack.Screen name="(admin)/dashboard" options={{ headerShown: false, statusBarHidden: false  }} />
        <Stack.Screen name="(admin)/editProject" options={{ headerShown: false, statusBarHidden: false  }} />
      </Stack>
    </LoadingProvider>
  );
  return ui;
